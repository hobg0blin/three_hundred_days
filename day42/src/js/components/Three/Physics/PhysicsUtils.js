...
//code from https://github.com/mrdoob/three.js/blob/dev/examples/physics_ammo_break.html
			...
			function createObjects() {
				...
				sphereGeometry.translate( 5, 20, 0 );
				createSoftVolume( sphereGeometry, volumeMass, -1 );
...
const obstacleShape = new Ammo.btSphereShape(obstacleRadius)
        ...
        const normalMap1 = textureLoader.load('textures/Water_2_M_Normal.jpg')
				...
				const volume = new Water( bufferGeom,  {scale: 2, textureWidth: 1024, textureHeight: 1024, flowMap: flowMap, normalMap0: normalMap0, normalMap1: normalMap1, flowDirection: new Vector2(1, 1), color: '#67f2f5'});
