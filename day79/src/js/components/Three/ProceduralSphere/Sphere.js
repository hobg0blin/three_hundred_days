...
if (newY < lowestY) {
       ...
       floor = BufferGeometryUtils.mergeVertices(floor, options.range)
        ...
        videoTex.repeat.set(2, 2, 2)
        let floorMaterial = new MeshPhongMaterial({ map: videoTex, emissive:0x000000, /*shininess: 200,/* wireframe: true* for multicolor:  vertexColors: true*/})
