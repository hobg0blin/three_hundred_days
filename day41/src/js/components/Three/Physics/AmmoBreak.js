import {MathUtils, BoxGeometry, SphereGeometry, Mesh, Vector2, Vector3, MeshPhongMaterial, RepeatWrapping, Quaternion, TextureLoader} from 'three'
...
const pos = new Vector3();
		...
		function createObject( mass, halfExtents, pos, quat, material ) {
			...
			const object = new Mesh( new SphereGeometry( halfExtents.x * 2, halfExtents.y * 2, halfExtents.z * 2 ), material );
...
//			createObject( bridgeMass, bridgeHalfExtents, pos, quat, createMaterial( 0xB3B865 ) );
			...
			// Stones
			const stoneMass = 120;
			const stoneHalfExtents = new Vector3( 2, 4, 4);
			const numStones = 5;
			quat.set( 0, 0, 0, 1 );
			...
			let hankTex = textureLoader.load('textures/hank.jpg')
					...
					hankTex.offset.set(0, -.65, 0)
				let stoneMat = new MeshPhongMaterial({ map: hankTex})
				createObject( stoneMass, stoneHalfExtents, pos, quat, stoneMat);
}
			}
