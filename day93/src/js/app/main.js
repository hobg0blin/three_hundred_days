...
setup() {
  // CAMERA
        ...
        this.camera.position.set(0, 25, 500)
...
//        this.scene.fog = createFog(0xfcba03, 1, 1000)
  ...
  this.controls = createControls(this.camera, this.renderer)
    ...
    addObjects() {
      ...
      // can't create particle system before sky - why?
      let particleSystem = createParticles(5000, new THREE.Color(0xFFFFFF), 5, {x: 2000, y: 2000, z: -50}, {x: -2000, y: -2000, z: -1000})
      ...
      let floor = createSphere({width: 100, height: 100, segments: 50, range: 10})
      floor.position.y = -75
      obj.add(floor)
...
//				gui.add( this.effectController, 'exposure', 0, 1, 0.0001 ).onChange( this.guiChanged );
    ...
    animate() {
        for (let object of this.objects) {
          orbit(object, getRandomInt(550, 850), 1, 10, clock.getElapsedTime())
        }
