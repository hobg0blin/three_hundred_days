...
//			geometry.rotateY( - Math.PI/2)
		...
		for (let text of this.text) {
			...
			console.log('text: ', text)
				pos.set(inc, 30, 20)
			let shape = new Ammo.btBoxShape(new Ammo.btVector3(6, 8, 6))
				createObject(text, Math.random()* 100, pos , quat, shape)
		}
...
//
//					const debris = convexBreaker.subdivideByImpact( threeObject0, impactPoint, impactNormal, 0.5,0.5 );
//
...
//
//					const debris = convexBreaker.subdivideByImpact( threeObject1, impactPoint, impactNormal, 0.5, 0.5 );
//
//					const numObjects = debris.length;
//					for ( let j = 0; j < numObjects; j ++ ) {
//
