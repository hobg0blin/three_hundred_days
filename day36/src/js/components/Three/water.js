...
function createWater() {
        ...
        const waterGeo = new PlaneGeometry(1000, 400)
        let water = new Water(waterGeo, {scale: 2, textureWidth: 1024, textureHeight: 1024, flowMap: flowMap, normalMap0: normalMap0, normalMap1: normalMap1, flowDirection: new Vector2(1, 1), color: '#ffffff'})
//            water.position.y = 15
//            water.rotation.x = Math.PI * -0.5
        //
        water.rotation.x = Math.PI * -0.5
        let waterBase = new PlaneGeometry(1000, 400)
