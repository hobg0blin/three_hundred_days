import { SphereGeometry,BufferAttribute, MeshLambertMaterial, Mesh, TextureLoader} from 'three'
...
let newY =               floor.attributes.position.getY(i)
    ...
    let texture = loader.load('textures/hank.jpg')
    texture.repeat.set(1.75, 1.75)
    let floorMaterial = new MeshLambertMaterial({ map: texture , emissive:0x000000, reflectivity: 1, refractionRatio: 0.98/* for multicolor: vertexColors: true */})
