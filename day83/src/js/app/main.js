...
import {makeBars} from '../components/Three/bars.js'
...
//  this.scene.add(ground)
    ...
    addObjects() {
      this.initFlocking()
      let width = 700
      let wall = makeBars(width, 15)
      wall.position.z = width/2
      let wall2 = wall.clone()
      wall2.rotation.x = THREE.MathUtils.degToRad(90)
      wall2.position.set(0, width/2, 0)
      let wall3 = wall2.clone()
      wall3.position.set(0, -width/2, 0)
      let wall4 = wall.clone()
      wall4.position.z = -width/2
      let wall5 = wall.clone()
      wall5.position.set(width/2, 0, 0)
      wall5.rotation.y = THREE.MathUtils.degToRad(90)
      let wall6 = wall5.clone()
      wall5.position.set(-width/2, 0, 0)
      this.scene.add(wall, wall2, wall3, wall4, wall5, wall6)
