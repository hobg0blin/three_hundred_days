...
//        this.camera.lookAt(this.scene.position)
        ...
        this.light[0].position.set(5, 50, 5)
...
//        this.scene.add(this.light[1])
        ...
        this.scene.fog = createFog(0xffea4d, 50, 250)
        // CONTROLS
        createControls(this.camera, this.renderer, this.light[0])
        //GROUND
        const ground = new THREE.PlaneGeometry(200, 200, 10, 10)
//        this.scene.add(ground)
        // shapes & textures
        //        this.camera.lookAt(this.keyboard[18])
        let groundMesh = createFloor({width: 200, height: 200, segments: 25, range: 10})
 ...
 //       this.camera.lookAt(groundMesh)
        ...
        let waterBase = new THREE.PlaneGeometry(200, 200)
