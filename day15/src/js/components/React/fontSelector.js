...
function FontSelector(props) {
  ...
  return <div className="w-full basis-1/4 mx-auto text-center my-3"><select className="basis-1/4 mt-1 px-3 py-2 bg-white border w-400 border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 my-5" defaultValue={currentFont} >
    {fonts}
  </select>
  </div>
