...
//        this.scene.fog = createFog(0xffea4d, 15, 2000)
        ...
        //GROUND
        const ground = new THREE.Mesh(new THREE.PlaneGeometry(100, 100, 1, 1), new THREE.MeshPhongMaterial({ color: 0x4287f5, shininess: 30, emissiveIntensity: 10}))
    ...
    render(time, i) {
        ...
        for (let key in currentKeys) {
            ...
            if (currentKeys[key] == 'off') {
                this.keyboard[key - 48].scale.y -= 0.05
                if (this.keyboard[key-48].scale.y == 1){
