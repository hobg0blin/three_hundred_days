...
//        this.scene.fog = createFog(0xffea4d, 50, 650)
        ...
        let yPos = 0;
        for (let i = 0; i < 6; i ++) {
        let terrainMesh = createSphere({width: 540, height: 500, segments: 155, range: 1})
    terrainMesh.position.y = xPos
    terrainMesh.position.x = yPos
...
//                if (mod > 0) {
                 ...
                 animateSphere(sphere.geometry, 1)
//}
}
