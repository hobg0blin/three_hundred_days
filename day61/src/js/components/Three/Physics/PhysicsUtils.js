...
const obstacleShape = new Ammo.btSphereShape(obstacleRadius)
				...
				for (let globe of this.globes) {
					...
					pos.set(globe.randPos[0], globe.randPos[1], globe.randPos[2])
					let globeBody = createRigidBody(globe, globeShape, globeMass, pos, quat)
					globe.userData.physicsBody = globeBody
					rigidBodies.push(globe)
					this.scene.add(globe)
					physicsWorld.addRigidBody(globeBody)
				}
